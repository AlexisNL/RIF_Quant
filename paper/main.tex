...
Regime labels (Calm, Intermediate, Stressed) are assigned post-estimation by a composite microstructure stress proxy computed on the \emph{original} LOB features---not on the Wasserstein distances used as HMM inputs. For each observation at time $t$ in regime $r$, I compute:
\begin{equation}
